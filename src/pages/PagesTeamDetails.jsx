...
//         <p className="relative mt-2 text-lg">{doctor.specialty}</p>
...
//           <img src={doctor.image} alt={doctor.name} className="rounded-2xl w-full object-cover shadow-lg" />
//         </div>
//         <div className="flex-1">
//           <h2 className="text-3xl font-bold mb-4">{doctor.name}</h2>
//           <p className="text-blue-600 text-lg font-medium mb-4">{doctor.specialty}</p>
//           <p className="text-gray-600 mb-6">
//             This is detailed info about {doctor.name}. You can add experience, education, special treatments, and any other relevant info here.
//           </p>
